...
**Access the Tutorial**:
For a step-by-step guide regarding how to use FREDS refer to the tutorial linked here: [FREDS Development Setup Tutorial](https://youtu.be/PEVLJlpf_3M?si=uI2_WCSj88NIUJcD).
